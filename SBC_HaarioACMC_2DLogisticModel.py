...
# Create a uniform prior over both two parameters 
...
df.to_excel('./2DLogisticsModel_HaarioACMC_convergence_record'+current_date_and_time_string+'.xlsx')
...
plt.savefig('./2DLogisticsModel_HaarioACMC_convergence_record'+current_date_and_time_string+'.png',dpi=500,bbox_inches = 'tight')
time_end=time.time()
